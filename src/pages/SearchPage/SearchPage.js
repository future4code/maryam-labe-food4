...
const SearchPage = () => {
  ...
  const  {form, onChange} = useContext(GlobalContext)
...
const handleChooseCategory = (category) =>{
  ...
  const restaurants = exampleOfList
    .filter((restaurant) => {
  ...
  return (
    <>
      <SearchContainerStyle onClick={() => setSerachInputOnFocus(false)}>
        <Header />
        <SearchWrapper>
        <input
          type="text"
